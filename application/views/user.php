        ...
        <div class="container  wow fadeIn">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <br>
                    <div>
                        <h5 style="color:#505050 ; font-size:20px" class="modal-title h2 ">แก้ไขข้อมูลส่วนตัว</h5>
                    ...
                    <div class="container" align="left">
                        <div class="row mt-1 ">
                            ...
                            <div class="modal-footer" style="margin:auto;"><br><br>
                                ...
                                <button type="button" class="btn btn-primary" onclick="edit_user(<?php echo $user[0]->id; ?>)">บันทึกการเปลี่ยนแปลง</button>
